...
public class AmqpConfiguration {
	...
	public Binding bindReqQtoExchange() {
		...
		return BindingBuilder.bind(requestQueue()).to(requestExchange()).with(requestKey);
	}
	...
	public Binding bindResQtoExchange() {
		...
		return BindingBuilder.bind(responseQueue()).to(responseExchange()).with(responseKey);
	}
